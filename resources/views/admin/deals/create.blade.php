@extends('admin.layouts.app',['title'=>'New Deals'])
@section('content')
    ...
    <div class="sl-mainpanel">
        <nav class="breadcrumb sl-breadcrumb">
            ...
            <span class="breadcrumb-item active">New Deal</span>
        </nav>
        <div class="sl-pagebody">
            ...
            <div class="card pd-20 pd-sm-40">
                <h6 class="card-body-title"> ADD New Deal
                        ...
                        <div class="row mg-b-25">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <h6 class="form-control-label">Quantity :   <span name="qyt"></span>

                                    </h6>

                                    <h6 class="form-control-label">Category :  <span name="category"></span></h6>
                                    <h6 class="form-control-label">Brand :  <span name="brand"></span></h6>
                                </div>
                            </div><!-- col-4 -->
